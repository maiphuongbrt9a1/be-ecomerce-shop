...
export class RequestsController {
  ...
  @ApiResponse({ status: 201, description: 'Create a new request', type: RequestEntity })
  ...
  @ApiResponse({ status: 200, description: 'Get all requests', type: [RequestEntity] })
  @Get()
  ...
  @ApiResponse({ status: 200, description: 'Get one request', type: RequestEntity })
  @Get('/:id')
  ...
  @ApiResponse({ status: 200, description: 'Update one request', type: RequestEntity })
  ...
  @ApiResponse({ status: 200, description: 'Delete one request', type: RequestEntity })
  @Delete('/:id')
