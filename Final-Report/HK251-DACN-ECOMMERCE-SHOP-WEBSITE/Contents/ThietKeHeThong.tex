...
\begin{enumerate}
  ...
  \item Đơn hàng chờ xử lý:
        \begin{figure}[H]
          \centering
          \includegraphics[width=1\textwidth]{Images/MockUp/Customer/Orders/Pending.png}
          \vspace{0.5cm}
  ...
  \item Đơn hàng đang giao:
        \begin{figure}[H]
          \centering
          \includegraphics[width=1\textwidth]{Images/MockUp/Customer/Orders/On the way.png}
          \vspace{0.5cm}
  ...
  \item Đơn hàng đã hoàn thành:
        \begin{figure}[H]
          \centering
          \includegraphics[width=1\textwidth]{Images/MockUp/Customer/Orders/Finished.png}
          \vspace{0.5cm}
  ...
  \item Đơn hàng đã hủy:
        \begin{figure}[H]
          \centering
          \includegraphics[width=1\textwidth]{Images/MockUp/Customer/Orders/Cancelled.png}
          \vspace{0.5cm}
  ...
  \item Đơn hàng trả hàng:
        \begin{figure}[H]
          \centering
          \includegraphics[width=1\textwidth]{Images/MockUp/Customer/Orders/Returned.png}
          \vspace{0.5cm}
...
\begin{figure}[H]
  ...
  \vspace{0.5cm}
  \caption{Giao diện chi tiết đơn hàng (Admin)}
  \label{fig: Giao diện chi tiết đơn hàng (Admin)}
\end{figure}
\noindent\textbf{Mô tả:} Hiển thị ngày đặt, trạng thái, khách hàng, địa chỉ giao, phương thức thanh toán, chi tiết sản phẩm (biến thể, số lượng, giá), phí vận chuyển, voucher, tổng tiền, lịch sử cập nhật trạng thái. Cho phép xác nhận, đóng gói, bàn giao vận chuyển, cập nhật trạng thái, xử lý hủy/hoàn tiền.
...
\end{figure}
\noindent\textbf{Mô tả:} Hiển thị thông tin thanh toán: mã giao dịch, đơn hàng liên quan, số tiền, phương thức (VNPay/COD/MoMo), trạng thái, biên lai/hoá đơn, lịch sử đối soát. Hỗ trợ xác minh, xuất báo cáo, và xử lý hoàn tiền khi cần.
...
\begin{figure}[H]
  ...
  \label{fig: Giao diện chi tiết giao dịch}
\end{figure}
\noindent\textbf{Mô tả:} Hiển thị thông tin thanh toán: mã giao dịch, đơn hàng liên quan, số tiền, phương thức (VNPay/COD/MoMo), trạng thái.
